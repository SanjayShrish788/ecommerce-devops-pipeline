...
// Use the "test" profile which configures an H2 in-memory DB,
// so these tests run in CI without requiring a live MySQL connection.
@SpringBootTest
@ActiveProfiles("test")
class EcommerceApplicationTests {
    ...
    @Test
    void contextLoads() {
        // Test 1: Controller Smoke Test — verifies the Spring context starts correctly
